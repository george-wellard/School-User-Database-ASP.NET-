   ...
   <form id="form1" runat="server">
    ...
    <asp:Label ID="lblError" runat="server" ForeColor="Red" 
        ...
        <asp:TextBox ID="TxtSearch" runat="server"         
            style="z-index: 1; left: 362px; top: 224px; position: absolute" ></asp:TextBox>

        <asp:Button ID="btnSearchCourse" runat="server" onclick="btnSearchCourse_Click" 
        style="z-index: 1; left: 363px; top: 257px; position: absolute" 
        Text="Search Course" />
